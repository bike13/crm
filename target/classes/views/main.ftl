        ...
        <div class="layui-side-scroll layui-left-menu">
            <#--通过seq_contains取判断包含-->
                <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                    <#if Permissionlist?seq_contains("10")>
                    ...
                    <#if Permissionlist?seq_contains("20")>
                    <li class="layui-nav-item">
                    ...
                    <#if Permissionlist?seq_contains("30")>
                    <li class="layui-nav-item">
                    ...
                    <#if Permissionlist?seq_contains("40")>
                    <li class="layui-nav-item">
                    ...
                    <#if Permissionlist?seq_contains("50")>
                    <li class="layui-nav-item">
